...
import { TrainingHeroTabs } from "@/app/components/programs/training/hero/tabs";
import { TrainingTabPanels } from "@/app/components/programs/training/sections";
import {
  isTrainingTab,
  type TrainingTab,
} from "@/lib/programs-training";
import type {
  ConsultingContent,
  ExecutiveContent,
  ExpertsContent,
...
export function TrainingPageClient({
  ...
  const activeTab = useMemo(() => {
    ...
    return tabParam && isTrainingTab(tabParam) ? tabParam : null;
  }, [searchParams]);
  ...
  const onBack = useCallback(() => {
    router.push("/programs/training", { scroll: true });
  }, [router]);
