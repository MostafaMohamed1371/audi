...
$publicPrograms = folder('البرامج — Programs', [
    ...
    publicReq('دليل بوابة التنمية', 'Get Development Portal Directory', 'GET', '/api/v1/programs/urban-policies/directory', [
        ...
        'description' => publicMatch('/api/v1/programs/urban-policies/directory', 'Directory rows: include `directory.rows` in **program-section-details** step 03, or edit via `directory/*` CRUD.'),
    ]),
]);
...
MD),
    ...
    postmanAdminFolder('01 — مرجع CRUD', '01 — CRUD Reference', [
        ...
        'citySize' => 'large',
        'sortOrder' => 0,
    ], ['publicPath' => '/api/v1/programs/urban-policies/directory', 'labelAr' => 'مدينة', 'description' => 'Directory cities. Build guide: `directory.rows.cities` in developmentPortal details step 03.'])),
    postmanAdminFolder('دليل المشاريع', 'Directory Projects', adminCrud('directory/projects', 'Directory Project', [
        ...
        'endDate' => '2023',
        'sortOrder' => 0,
    ], ['publicPath' => '/api/v1/programs/urban-policies/directory', 'labelAr' => 'مشروع', 'description' => 'Directory projects. Build guide: `directory.rows.projects` in step 03.'])),
    postmanAdminFolder('دليل المنظمات', 'Directory Organizations', adminCrud('directory/organizations', 'Directory Organization', [
        ...
        'sortOrder' => 0,
    ], ['publicPath' => '/api/v1/programs/urban-policies/directory', 'labelAr' => 'منظمة', 'description' => 'Directory organizations. Build guide: `directory.rows.organizations` in step 03.'])),
    postmanAdminFolder('دليل المنشورات', 'Directory Publications', adminCrud('directory/publications', 'Directory Publication', [
        ...
        'sortOrder' => 0,
    ], ['publicPath' => '/api/v1/programs/urban-policies/directory', 'labelAr' => 'منشور', 'description' => 'Directory publications. Build guide: `directory.rows.publications` in step 03.'])),
