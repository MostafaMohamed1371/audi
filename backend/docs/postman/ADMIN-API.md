...
Training grid on ?tab=trainingPrograms. Full seed: **بناء برنامج التدريب** steps 10–15.استخدم `id` من استجابة الإنشاء.
...
Experts carousel on ?tab=experts. Full seed: **بناء برنامج التدريب** steps 16–18.استخدم `id` من استجابة الإنشاء.
